...
Canonical replacement setup uses WU-C2 and onecompany-a4-wu-c2. The abandoned WU-C branch remains untouched for audit; never delete it or force-update it. Target PR #5 must be the sole WU-C2 experiment.
